...
<!-- Mirrored from thememascot.net/demo/personal/s/kidspro/v2.0/demo/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Mar 2018 22:31:21 GMT -->
<head>
...
<div id="wrapper" class="clearfix">
  ...
  <footer id="footer" class="footer text-center bg-black-222">
    <div class="container pt-10 pb-10">
      <div class="row">
        <div class="col-md-12">
          <p class="text-white mb-0">Copyright &copy;2017 ThemeMascot. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </footer>
