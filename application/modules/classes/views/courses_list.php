...
<!-- Mirrored from thememascot.net/demo/personal/s/kidspro/v2.0/demo/page-course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Mar 2018 22:31:21 GMT -->
<head>
    ...
    <section>
      <div class="container">
          ...
          <div class="col-md-9 blog-pull-right">
            <div class="row mb-15">
              ...
              <div class="col-sm-6 col-md-8">
                <h3 class="mt-0 mt-sm-20">Learning Classes</h3>
                <h4 class="text-theme-color-blue"><span class="text-theme-color-red">Price-$250</span> Age: 3 - 5 Years, Size: 9 Seats</h4>
                ...
                <a class="btn btn-dark btn-theme-color-sky btn-sm text-uppercase mt-10" href="page-courses-learning-classes.html">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/project/lg2.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h3 class="mt-0 mt-sm-20">Drawing Classes</h3>
                <h4 class="text-theme-color-blue"><span class="text-theme-color-red">Price-$250</span> Age: 3 - 5 Years, Size: 9 Seats</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam aliquam ipsum quis ipsum facilisis sit amet.Aliquam ipsum quis ipsum facilisis sit ame ipsum quis ipsum facilisis sit amet facilisis consecte.</p>
                <a class="btn btn-dark btn-theme-color-sky btn-sm text-uppercase mt-10" href="page-courses-drawing-classes.html">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/project/lg3.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h3 class="mt-0 mt-sm-20">Langauge Classes</h3>
                <h4 class="text-theme-color-blue"><span class="text-theme-color-red">Price-$250</span> Age: 3 - 5 Years, Size: 9 Seats</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam aliquam ipsum quis ipsum facilisis sit amet.Aliquam ipsum quis ipsum facilisis sit ame ipsum quis ipsum facilisis sit amet facilisis consecte.</p>
                <a class="btn btn-dark btn-theme-color-sky btn-sm text-uppercase mt-10" href="page-courses-langauge-classes.html">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/project/lg4.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h3 class="mt-0 mt-sm-20">Math Classes</h3>
                <h4 class="text-theme-color-blue"><span class="text-theme-color-red">Price-$250</span> Age: 3 - 5 Years, Size: 9 Seats</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam aliquam ipsum quis ipsum facilisis sit amet.Aliquam ipsum quis ipsum facilisis sit ame ipsum quis ipsum facilisis sit amet facilisis consecte.</p>
                <a class="btn btn-dark btn-theme-color-sky btn-sm text-uppercase mt-10" href="page-courses-math-classes.html">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/project/lg5.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h3 class="mt-0 mt-sm-20">Multimedia Classes</h3>
                <h4 class="text-theme-color-blue"><span class="text-theme-color-red">Price-$250</span> Age: 3 - 5 Years, Size: 9 Seats</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam aliquam ipsum quis ipsum facilisis sit amet.Aliquam ipsum quis ipsum facilisis sit ame ipsum quis ipsum facilisis sit amet facilisis consecte.</p>
                <a class="btn btn-dark btn-theme-color-sky btn-sm text-uppercase mt-10" href="page-courses-multimedia-classes.html">view details</a>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="sidebar sidebar-left mt-sm-30">
              <div class="widget">
                <h3 class="widget-title line-bottom">Search <span class="text-theme-color-red">Courses</span></h3>
              ...
              <div class="widget">
                <h3 class="widget-title line-bottom">Photos <span class="text-theme-color-red">from Flickr</span></h3>
              ...
              <div class="widget">
                ...
                <form id="quick_contact_form_sidebar" name="footer_quick_contact_form" class="quick-contact-form" action="http://thememascot.net/demo/personal/s/kidspro/v2.0/demo/includes/quickcontact.php" method="post">
        ...
        <div class="row">
          <div class="col-sm-12">
            <nav>
              <ul class="pagination theme-color-sky xs-pull-center m-0">
...
<!-- Mirrored from thememascot.net/demo/personal/s/kidspro/v2.0/demo/page-course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Mar 2018 22:31:31 GMT -->
</html>