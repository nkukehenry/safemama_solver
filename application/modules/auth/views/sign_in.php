...
<meta name="description" content="Course Author Login">
	...
	<div class="container-fluid">
		<div class="row clearfix">
			<div class="col-lg-9 col-md-8 col-xs-12 p-l-0">
				<div class="l-detail">
					<h3 class="position">Welcome to</h3>
					<h1 class="position" style="color: orange;">
						<span><?php echo $config->system_name; ?></span> </h1>
