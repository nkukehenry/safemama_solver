...
?>
   ...
   <div class="widget" style="padding-left: 10%;padding-right: 10%;">
         ...
         if(count($courses)==0){
            ...
            $noresults= "<h2>This school has not added courses yet</h2><br> <a class='btn btn-lg btn-default' href='".base_url()."courses'> View all courses</a>";
          }
    ...
    <h3>Courses  by <?php echo $otherschool->schoolname; ?></h3>
